...
const Cart = () => {
  ...
  const handleCheckOutPage = () => {
    if (!userInfo?.mobile_Number || !userInfo?.postal_Code || !userInfo?.province || !userInfo?.street_Address) {
      Swal.fire({
        title: 'Warning!',
          ...
          <div className='w-full lg:w-[30%]'>
            ...
            <div className='w-full bg-white rounded h-40 shadow-lg  p-4 mt-5'>
              ...
              <div className='w-full px-3 py-2 mt-2 flex text-center'>
                <button className='w-full py-2 bg-green-600 hover:bg-green-800 text-white  text-sm font-medium shadow' onClick={handleCheckOutPage}>Proceed to Checkout</button>
              </div>
