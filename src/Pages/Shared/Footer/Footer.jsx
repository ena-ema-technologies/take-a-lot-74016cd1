    ...
    return (
        ...
        <footer id="footer" className="relative z-50 dark:bg-gray-900 pt-24">
                        ...
                        <div className="w-full lg:w-1/2 mb-16 lg:mb-0 flex">
                            <div className="w-full lg:w-1/2 px-6">
                                <ul>
                                    ...
                                    <li className="mt-6">
                                        <a to="javascript:void(0)" className="text-xs lg:text-sm leading-none hover:text-brand dark:hover:text-brand text-gray-800 dark:text-gray-50">
                                            Documentation
                                        </a>
                                    </li>
                                </ul>
            ...
            <div className="py-16 flex flex-col justify-center items-center">
                <Link to="javascript:void(0)">
                    <a>
                        <svg className="dark:text-white" xmlns="http://www.w3.org/2000/svg" width={86} height={58} viewBox="0 0 86 58" fill="none">
                            ...
                            <path d="M42.4701 8.98888H47.7911V4.49438H42.4701V8.98888Z" fill="#FF3565" />
                            <path d="M47.7914 8.98888H53.1124V4.49438H47.7914V8.98888Z" fill="#E2E2E2" />
                            <path d="M75.0956 23.7122L86.0001 8.98898H73.2641L65.5874 20.8944V0H55.0228V39.1479H65.5874V32.7501L67.6415 29.9918L72.5134 39.1479H85.485L75.0956 23.7122Z" fill="currentColor" />
                            ...
                            <path d="M42.4704 28.8132C42.1827 30.9153 40.4058 32.5423 38.2237 32.5423C35.8403 32.5423 33.9085 30.6105 33.9085 28.2271V0H23.4141V29.1628C23.4141 36.1931 29.8909 39.143 34.7815 39.143C39.6811 39.143 41.0644 38.0173 42.4704 36.7702V28.8132Z" fill="currentColor" />
                            <path d="M42.5479 39.1479H53.1124V38.0271H42.5479V39.1479Z" fill="#FF3565" />
                            <path d="M42.4701 39.1479H53.1121V10.7993H42.4701V39.1479Z" fill="#FF3565" />
                            <path d="M0 0V9.76985H10.5059V39.1479H21.6851V9.78371H23.4139V10.3298H33.9084V0H0Z" fill="currentColor" />
                            <path
                                fillRule="evenodd"
                                clipRule="evenodd"
